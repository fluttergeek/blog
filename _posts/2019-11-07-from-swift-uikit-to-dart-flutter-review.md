...
For a previous Android developer, which I also used to be, well, Flutter is a way much easier way to develop apps. Though, coding with Flutter feels so much closer to Android development than UIKit. A huge reason why I find UIKit easier. But if you've never tried Xcode at all, you'll still feel at home with Flutter, and the best part is it's lightweight.
