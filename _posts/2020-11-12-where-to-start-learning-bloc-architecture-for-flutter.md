...
His videos start getting longer at episode 2 but it's well worth it. His tutorials has a more theoretical way of teaching BloC, but it's not boring I promise you and most of all it's well worth it. You might just have to rewatch those videos because it's a little fast for someone who might not fully grasp BloC from CodeX yet, and that BloC is packed with different kinds widgets and boilerplate you need to know. There are also examples, but he doesn't go writing an app to fully visualize those examples. But then again, his explanations are superb.