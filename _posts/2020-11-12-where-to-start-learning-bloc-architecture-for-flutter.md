...
His videos start to get longer at episode 2 onward which can reach up to almost 30 minutes each on the latter part but it's well worth it. His tutorials has a more theoretical way of teaching BloC, but it's not boring I promise you. You might just have to rewatch those videos because it's a little fast for someone who might not fully grasp BloC from CodeX yet, and that the BloC dependency is packed with different kinds widgets and boilerplate that is a must know. There are also code examples, but he doesn't go writing an app to fully visualize those examples. But then again, his explanations are superb.